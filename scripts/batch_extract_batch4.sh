#!/bin/bash
# Batch 4: 3个视频 (0021, 0022, 0024)，93分钟
# 输出到 extracted_signs/DJI_batch4/
set -e
cd /Users/justin/Desktop/GLM_Labeling
source venv/bin/activate
[ -z "$ZAI_API_KEY" ] && echo "请设置 ZAI_API_KEY" && exit 1

BATCH_OUTPUT="extracted_signs/DJI_batch4"
mkdir -p "$BATCH_OUTPUT"

SOURCE_DIR="/Volumes/LQ1000/DJI_4K"

# Batch 4: 0021(24分钟) + 0022(40分钟) + 0024(29分钟) = 93分钟
VIDEOS=(
    "DJI_20250621091741_0021_D.MP4"
    "DJI_20250621110528_0022_D.MP4"
    "DJI_20250621121712_0024_D.MP4"
)

echo "========================================"
echo "Batch 4: 提取交通标志 (3个视频, 93分钟)"
echo "视频: 0021, 0022, 0024"
...
echo ""
echo "========================================"
echo "Batch 4 完成! $(date)"
echo "总计提取: $TOTAL 张标志图片"
echo "输出目录: $BATCH_OUTPUT"
echo ""
echo "下一步: 运行标注工具"
echo "  python scripts/sign_labeling_ui.py --batch 4"
echo "========================================"
