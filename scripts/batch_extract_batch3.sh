#!/bin/bash
# Batch 3: 3个视频 (0019, 0020, 0027)，87分钟
# 输出到 extracted_signs/DJI_batch3/
set -e
cd /Users/justin/Desktop/GLM_Labeling
source venv/bin/activate
[ -z "$ZAI_API_KEY" ] && echo "请设置 ZAI_API_KEY" && exit 1

BATCH_OUTPUT="extracted_signs/DJI_batch3"
mkdir -p "$BATCH_OUTPUT"

SOURCE_DIR="/Volumes/LQ1000/DJI_4K"

# Batch 3: 0019(41分钟) + 0020(25分钟) + 0027(21分钟) = 87分钟
VIDEOS=(
    "DJI_20250602175038_0019_D.MP4"
    "DJI_20250602183211_0020_D.MP4"
    "DJI_20250705084225_0027_D.MP4"
)

echo "========================================"
echo "Batch 3: 提取交通标志 (3个视频, 87分钟)"
echo "视频: 0019, 0020, 0027"
...
echo ""
echo "========================================"
echo "Batch 3 完成! $(date)"
echo "总计提取: $TOTAL 张标志图片"
echo "输出目录: $BATCH_OUTPUT"
echo ""
echo "下一步: 运行标注工具"
echo "  python scripts/sign_labeling_ui.py --batch 3"
echo "========================================"
